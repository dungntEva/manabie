import 'package:flutter_manabie_redux_mvvm/features/addBlog.dart';
import 'package:flutter_manabie_redux_mvvm/features/gallery/GalleryScreen.dart';
import 'WelcomePage.dart';
import 'HomeScreen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_secure_storage/flutter_secure_storage.dart';
import 'package:flutter_manabie_redux_mvvm/config/NetworkHandler.dart';
...
class _HomePageState extends State<HomePage> {
  int currentState = 0;
  List<Widget> widgets = [HomeScreen(), GalleryScreen()];
